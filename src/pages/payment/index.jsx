      ...
      <div className={styles.header} id="header">
        <div className={styles.header__left}>
          <ul>
            ...
            <li className={styles.header__li}>
              <a href="" className={`${styles.header__li__link} ${styles.mobile__header__li}`}onClick={Home}>Home</a>
            </li>
            <li className={styles.header__li}>
              <a href="" className={`${styles.header__li__link} ${styles.mobile__header__li}`}
                >List Movie</a
              >
            </li>
          </ul>
      ...
      <div className={styles.main__container1}>
        <div className={styles.main__info}>
          ...
          <div className={styles.main__info__container}>
            <div className={`${styles.main__info__1} ${styles.main__info__11}`}>
              <h3>Date & time</h3>
              <h4>{state.dateBooking} at {state.time}</h4>
            </div>
            <hr />
            <div className={`${styles.main__info__1} ${styles.main__info__12}`}>
              <h3>Movie title</h3>
              <h4>{state.movieName}</h4>
            </div>
            <hr />
            <div className={`${styles.main__info__1} ${styles.main__info__13}`}>
              <h3>Cinema name</h3>
              <h4>{state.premiere} Cinema</h4>
            </div>
            <hr />
            <div className={`${styles.main__info__1} ${styles.main__info__14}`}>
              <h3>Number of tickets</h3>
              <h4>3 pieces</h4>
            </div>
            <hr />
            <div className={`${styles.main__info__1} ${styles.main__info__price}`}>
              <h3>Total payment</h3>
        ...
        <div className={styles.main__personal__container}>
          ...
          <div className={`mb-3 ${styles.mb_3}`}>
            ...
            <input
              ...
              value={`${dataUser[0].firstName}  ${dataUser[0].lastName}`}
              readOnly
            />
          </div>
          <div className={`mb-3 ${styles.mb_3}`}>
          ...
          <div className={`mb-3 ${styles.mb_3} ` }>
            <label for="exampleInputPhone1" className={`form-label`}
              >Phone Number</label
            >
            <div className={`input-group ${styles.main__personal__input} ${styles.input_group}`}>
              <span className={`input-group-text`} id="addon-wrapping">+62 </span>
              <input
                type="tel"
                className={`form-control ${styles.form__control__telp}`}
                id="exampleInputPhone1"
                value={`${dataUser[0].noTelp}`}
                aria-describedby="addon-wrapping"
                disabled
              />
            </div>
          </div>
          <div className={`alert alert-warning ${styles.alert} ${styles.alert_warning}`}>
